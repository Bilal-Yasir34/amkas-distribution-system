        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900 space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">Category name</label>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                <label className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">Category code</label>
                <input
                  type="text"
                  value={code}
              ...
              <label className="flex items-center gap-2 pt-1 cursor-pointer">
                ...
                />
                <span className="text-xs font-medium text-slate-700 dark:text-slate-300">Active Category</span>
              </label>
            </div>
